  ...
  return (
    <div className="footer-container">
      <section className="footer-subscription">
        <p className="footer-subscription-heading">Join the Binar Games newsletter to receive our update</p>
      ...
      <div class="footer-links">
        <div className="footer-link-wrapper">
          <div class="footer-link-items">
            <h2>About Us</h2>
            <Link to="/sign-up">Background</Link>
            <Link to="/">Team</Link>
        ...
        <div className="footer-link-wrapper">
          <div class="footer-link-items">
            <h2>Videos</h2>
            <Link to="/Uploadimage">Submit Video</Link>
          </div>
          <div class="footer-link-items">
            <h2>Social Media</h2>
      ...
      <section class="social-media">
        <div class="social-media-wrap">
          ...
          <small class="website-rights">© Binar Kelompok 3. All rights reserved.</small>
